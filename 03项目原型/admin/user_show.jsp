...
<%@ taglib prefix="fn" 
		...
		<div id="table">
			<div class="add">
				<form action="/HE/admin/doUserSearch" method = "get">
			...
			<table cellpadding="0" cellspacing="0">
			 ...
			 <c:forEach items="${goods }" var="item" varStatus ="ide">
					<tr >
						...
						<td width="10%"><span @click="deletelist(item.id,index)" class="delete"><a href ="/HE/admin/doUserDelete?userid=${item.userid }" class="delete">删除</a></span></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
