...
<c:import url="header.jsp" charEncoding="utf-8" />
       <div class="login">
		...
		<div align = "center">
			<form action="/HE/shop/doSearch" method ="post">
...
<!-- 		           <a href=""><img src="images/arrow2.gif" alt="" class="v-middle"></a> -->
    		...
    		<script>
	    		function desc_sort(){
	    			...
	    			document.getElementById("desc").href = "/HE/shop/doSort?way=desc&type="+val; 
					
	    		}
	    		function asc_sort(){
	    			var val = document.getElementById("txt_type").value;
	    			document.getElementById("asc").href = "/HE/shop/doSort?way=asc&type="+val; 
		    	      ...
		    	      <c:set var="pics" value="${fn:split(item.prepicture, ',')}"/>
						 <ul class="list2">
						  <li>
							  ...
							  <li><a class="active-icon c1" href="/HE/shop/doAddCart?productid=${item.productid}&pname=${item.pname}&price=${item.price}&picture=${pics[0]}">加入包裹 </a>
