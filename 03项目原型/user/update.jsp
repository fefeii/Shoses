...
<script type="text/javascript" src="js/easing.js"></script>
   <script type="text/javascript">
		...
		function checkAll() {
				if (checkPwd()&&checkephone()&&checkEmail()&&checkSex()) {
							return true;
						} else{
							return false;
						}
...
<%@ taglib prefix="fn" 
 ...
 <c:import url="header.jsp" charEncoding="utf-8" />
  ...
  <div class="container">
    	      ...
    	      <div>${tip5 }</div>
    	         <form class="form-horizontal" action="/HE/shop/doupdate" method="post" onsubmit="return checkAll()" > 
    	         <input type="hidden" name="userid" value="good.userid">   			
                     <div class="col_1_of_2 span_1_of_2">
    			
    			
    			 <div class="form-group">
						<label for="username" class="col-md-2 control-label">用户名</label>
		   			 <div><input type="text" id="account" name="account" class="form-control" value="${good.account }" /></div></div>
		    			
		    			<div class="form-group">
						<label for="pwd" class="col-md-2 control-label">密码</label>&nbsp;&nbsp;<span id="pwdmsg">字母数字组合,6-20位</span>
		    			<div><input type="text" id="pwd" name="pwd" class="form-control" value="${good.pwd }" onblur="checkPwd()" / ></div></div>
		    			
		    			
		    			<div class="form-group">
						<label for="sex" class="col-md-2 control-label">性别</label>&nbsp;&nbsp;<span id="sexmsg">不为空</span>
		    			<div><input type="text" id="sex" name="sex" class="form-control" value="${good.sex }" onblur="checkSex()"></div></div>
		    	  ...
		    	  <div><input type="text" id="email" name="email" class="form-control" value="${good.email }" onblur="checkEmail()"></div></div>
		    	  ...
		    	  <div class="form-group">
		    		...
		    		<div><input type="text" id="tel" name="tel" class="form-control" value="${good.tel }" onblur="checkephone()" ></div></div>
